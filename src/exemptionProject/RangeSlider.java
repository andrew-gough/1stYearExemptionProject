...
public class RangeSlider extends JSlider {
    ...
    /**
     * Constructs a vertical RangeSlider with the specified default minimum and maximum values 
     * and the specified orientation
     * 
     * @parameter 	0 = Horizontal
     * 				1 = Vertical
     */
    
    public RangeSlider(int orientation, int minimum, int maximum){
